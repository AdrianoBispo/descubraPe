  ...
  return (
    <div className="container-bookingCards">
      <h1 className="font-bold titulo">
        Pernambuco: Cidades Badaladas
      </h1>
      <p className="ml-8 text-xl">Explore as cidades mais visitadas do estado</p>
        ...
        <div className="inline-block">
          ...
          >
            <CardHeader floated={false} color="blue-gray">
              <img src={cidade.image} alt="ui/ux review check" className="w-300 h-30" />
