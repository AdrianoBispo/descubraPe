...
export function Trilhas() {
  return (
    <>
      <h1 className="titulo">
        Explore Locais com um Mapa Interativo
      </h1>
        ...
        <main className="main">
            ...
            <div>
              ...
              <div className="cards">
                ...
                <div className="card">
                  ...
                  <p>
                    Capela histórica verde e branca construída no século XVII,
                ...
                <div className="card">
                  ...
                  <div className="estrelas"> 5.0 ⭐⭐⭐⭐⭐</div>
                  <p>
                    Consagrada como um dos monumentos barrocos mais importantes.
                  </p>
                  <button className="trilha-btn">Adicionar à Trilha</button>
                </div>
                <div className="card">
                  ...
                  <div className="estrelas"> 5.0 ⭐⭐⭐⭐⭐</div>
                  <p>
                    Um templo católico da cidade do Recife, capital do estado de
                    Pernambuco.
                  </p>
                  <button className="trilha-btn">Adicionar à Trilha</button>
                </div>
          ...
          <div className="right-column">
            <div className="map-wrapper">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3950.3833925172785!2d-34.8800266888442!3d-8.062318580527359!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x7ab18bb910ecf63%3A0xfe0a857a7c19ce2b!2sCapela%20Dourada!5e0!3m2!1spt-BR!2sbr!4v1746074421198!5m2!1spt-BR!2sbr"
                width="600"
                height="450"
